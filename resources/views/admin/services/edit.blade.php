...
@section('title', 'Editer le service')
@section("content")
<div class="row">
    <div class="col-lg-8">
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                <h3 class="fs-18 mb-4 border-bottom pb-20 mb-20">Create Service</h3>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58 @error('title') is-invalid @enderror"
                                        placeholder="Enter Services Tilte" name="title" value="{{$service->title}}">
                                    <i
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <textarea class="form-control ps-5 text-dark" placeholder="Some demo text ... " cols="30" rows="5" name="description">
                                        {{$service->description}}
                                    </textarea>
...
@enderror
                        ...
                        <div class="col-lg-12">
                            @if ("/storage/images/{{ $service->image }}")
...
@enderror
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <button type="submit"
                                    class="btn btn-primary py-3 px-5 fw-semibold text-white">Mettre à Jour
                                </button>
                            </div>
                        </div>
                    </div>
