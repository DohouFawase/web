   ...
   @include('components.backend.alerte')
    ...
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            ...
            <a href="{{ route('admin.image.create') }}" class="border-0 btn btn-primary py-2 px-3 px-sm-4 text-white fs-14 fw-semibold rounded-3">
                            ...
                            <td>
                                <div class="dropdown action-opt">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                        ...
                                        {{-- <li>
                                            <a class="dropdown-item" href=" {{ route('admin.image.edit', $image->id) }}">
                                        ...
                                        <li>
                                            ...
                                            <form action="
                                            {{ route('admin.image.destroy', $image->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
