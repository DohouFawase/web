  ...
  <div class="container flex justify-between items-center relative px-4">
    <h1>
      <a href=' {{ route('home') }}'>
        ...
        <img src="{{ asset('assets/imgs/template/DAHF.png') }}" alt="logo" class=" w-12 flex-shrink-0 relative dark:hidden">
        <img src="{{ asset('assets/imgs/template/DAHF.png"') }}" alt="logo" class=" w-12 flex-shrink-0 relative hidden dark:inline-block">
      </a>
    </h1>
    <ul class="xl:flex hidden">
      <li class="relative group">
        ...
        {{-- <ul class="z-100 absolute px-6 py-4 rounded-md left-4 bg-neutral-0 dark:bg-neutral-dark-0 min-w-48 shadow-sm mt-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-4 transition-all duration-500">
          <li><a class='menu-sub-item' href='index.html'>Home page 01</a></li>
          <li><a class='menu-sub-item' href='index-2'>Home page 02</a></li>
          <li><a class='menu-sub-item' href='index-3'>Home page 03</a></li>
        </ul> --}}
      </li>
      <li class="relative group">
        <a class="menu-item" href="{{ route('blog') }}">Blog</a>
        {{-- <ul class="z-100 absolute px-6 py-4 rounded-md left-4 bg-neutral-0 dark:bg-neutral-dark-0 min-w-48 shadow-sm mt-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-4 transition-all duration-500">
          <li><a class='menu-sub-item' href='category'>Category 01</a></li>
          <li><a class='menu-sub-item' href='category-2'>Category 02</a></li>
          <li><a class='menu-sub-item' href='category-3'>Category 03</a></li>
          <li><a class='menu-sub-item' href='category-4'>Category 04</a></li>
          <li><a class='menu-sub-item' href='single'>Single 01</a></li>
          <li><a class='menu-sub-item' href='single-2'>Single 02</a></li>
        </ul> --}}
      </li>
      <li class="relative group">
        <a class="menu-item" href=" {{ route('service') }}">Services</a>
        {{-- <ul class="z-100 absolute px-6 py-4 rounded-md left-4 bg-neutral-0 dark:bg-neutral-dark-0 min-w-48 shadow-sm mt-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-4 transition-all duration-500">
          <li><a class='menu-sub-item' href='page-about'>About me</a></li>
          <li><a class='menu-sub-item' href='page-author'>Author</a></li>
          <li><a class='menu-sub-item' href='page-search'>Search Results</a></li>
          <li><a class='menu-sub-item' href='page-contact'>Contact</a></li>
          <li><a class='menu-sub-item' href='page-login'>Login</a></li>
          <li><a class='menu-sub-item' href='page-register'>Register</a></li>
          <li><a class='menu-sub-item' href='page-forgot-password'>Forgot Password</a></li>
          <li><a class='menu-sub-item' href='page-404'>Error 404</a></li>
        </ul> --}}
      </li>
     
      <li class="relative"><a class='menu-item' href='mailto:roidahfifonsi@gmail.com'>roidahfifonsi@gmail.com</a></li>
      <li class="relative"><a class='menu-item' href='tel:+22962770733'>+22962770733</a></li>
    </ul> 
    <div class="flex justify-end align-middle content-center items-center relative gap-4">
          ...
          <div class="language absolute inline-flex flex-col gap-[2px] overflow-hidden min-w-32 h-[24px] top-0 left-0">
            ...
            <div class="language__el bg-neutral-0 dark:bg-neutral-dark-0 cursor-pointer" data-lang="cn">
              <div class="language__link flex gap-2 items-center">
                ...
                <span class="language__text text-sm text-neutral-700 dark:text-neutral-dark-300">ä¸­å½äºº</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="dark-light cursor-pointer flex relative z-20">
        ...
        <img src="{{ asset('assets/imgs/template/icon-dark-light.svg') }}" alt="dark/light" class="dark:hidden">
        <img src=" {{ asset('assets/imgs/template/icon-dark-light-white.svg') }}" alt="dark/light" class="hidden dark:inline-block">
      </div>
          ...
          <div class="relative mb-8">
            ...
            <div class="flex-col justify-start items-start gap-3 inline-flex mt-8">
              ...
              <div class="flex flex-wrap gap-4">
                <a href="index.html#" class="font-regular text-base text-neutral-700 link-hover hover:text-neutral-950 dark:text-neutral-0 dark:hover:text-neutral-dark-600">Events</a>
                <a href="index.html#" class="font-regular text-base text-neutral-700 link-hover hover:text-neutral-950 dark:text-neutral-0 dark:hover:text-neutral-dark-600">Shop</a>
                <a href="index.html#" class="font-regular text-base text-neutral-700 link-hover hover:text-neutral-950 dark:text-neutral-0 dark:hover:text-neutral-dark-600">Tech</a>
                <a href="index.html#" class="font-regular text-base text-neutral-700 link-hover hover:text-neutral-950 dark:text-neutral-0 dark:hover:text-neutral-dark-600">Fashion</a>
                <a href="index.html#" class="font-regular text-base text-neutral-700 link-hover hover:text-neutral-950 dark:text-neutral-0 dark:hover:text-neutral-dark-600">Books</a>
                <a href="index.html#" class="font-regular text-base text-neutral-700 link-hover hover:text-neutral-950 dark:text-neutral-0 dark:hover:text-neutral-dark-600">Travel</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="fixed top-0 left-0 bottom-0 w-5/6 max-w-xs bg-neutral-0 dark:bg-neutral-dark-0">
        <nav class="relative p-6 h-full overflow-y-auto">
          <div class="flex flex-col h-full">
            <h1 class="pt-2 pb-6">
              <a href='{{ route('home') }}'>
                {{-- {{ asset('assets/imgs/pages/thumb-05.png') }} --}}
                {{-- {{ asset('assets/imgs/template/DAHF.png"') }} --}}
                {{-- <img src="{{ asset('assets/imgs/pages/thumb-05.png"') }}" alt="logo" class="w-12 flex-shrink-0 relative dark:hidden"> --}}
                {{-- <img src="{{ asset('assets/imgs/template/DAHF.png"') }}" alt="logo" class=" w-12 flex-shrink-0 relative hidden dark:inline-block"> --}}
              </a>
            </h1>
            <ul class="py-6 mb-6 border-y border-neutral-300 dark:border-neutral-dark-300">
              <li class="has-children">
                <a class="menu-mobile-item" href="{{ route('home') }}">Home</a>
              </li>
              <li class="has-children">
                <a class="menu-mobile-item" href="{{ route('blog') }}">Blog</a>
                {{-- <ul class="sub-menu">
                  <li><a class='menu-mobile-sub-item' href='category'>Category 01</a></li>
                  <li><a class='menu-mobile-sub-item' href='category-2'>Category 02</a></li>
                  <li><a class='menu-mobile-sub-item' href='category-3'>Category 03</a></li>
                  <li><a class='menu-mobile-sub-item' href='category-4'>Category 04</a></li>
                  <li><a class='menu-mobile-sub-item' href='single'>Single 01</a></li>
                  <li><a class='menu-mobile-sub-item' href='single-2'>Single 02</a></li>
                </ul> --}}
              </li>
              <li class="has-children">
                <a class="menu-mobile-item" href=" {{ route('service') }}">Services</a>
                {{-- <ul class="sub-menu">
                  <li><a class='menu-mobile-sub-item' href='page-about'>About me</a></li>
                  <li><a class='menu-mobile-sub-item' href='page-author'>Author</a></li>
                  <li><a class='menu-mobile-sub-item' href='page-search'>Search Results</a></li>
                  <li><a class='menu-mobile-sub-item' href='page-contact'>Contact</a></li>
                  <li><a class='menu-mobile-sub-item' href='page-login'>Login</a></li>
                  <li><a class='menu-mobile-sub-item' href='page-register'>Register</a></li>
                  <li><a class='menu-mobile-sub-item' href='page-forgot-password'>Forgot Password</a></li>
                  <li><a class='menu-mobile-sub-item' href='page-404'>Error 404</a></li>
                </ul> --}}
              </li>
              {{-- <li><a class='menu-mobile-item' href='{{ route('apropos') }}'>Apropos</a></li> --}}
              {{-- <li><a class='menu-mobile-item' href='{{ route('contact') }}'>Contact</a></li> --}}
            </ul>

            <div class="flex flex-wrap flex-col mt-4">
              <a class='w-full p-4 text-neutral-950 bg-primary-light-950 rounded-md font-bold text-sm' href='{{ route('login') }}'>Connectez-vous</a>
            </div>
          </div>
        </nav>
        <a class="navbar-close absolute top-5 p-4 right-3" href="{{ route('home') }}">
